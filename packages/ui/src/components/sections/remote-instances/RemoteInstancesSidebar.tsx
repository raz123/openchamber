...
import { RiAddLine, RiDeleteBinLine, RiGlobalLine, RiPlug2Line, RiRefreshLine, RiStopLine } from '@remixicon/react';
  ...
  return (
    ...
    >
      <SettingsSidebarItem
        ...
        icon={<RiGlobalLine className="h-4 w-4 text-muted-foreground" />}
      />
